...
document.addEventListener("DOMContentLoaded", function () {
            ...
            if (confirmed) {
                fetch('/repasse', {
                    ...
                    .then(data => {
                        const modalAlerts = document.querySelector(".modal-alerts-dashboard");
                        const alert = document.createElement("div");
                        alert.classList.add("alert", "alert-success", "modal-alert-dashboard");
                        alert.setAttribute("role", "alert");

                        alert.innerText = data.mensagem
                    ...
                    .catch(error => {
                        ...
                        alert.innerText = error.mensagem
    ...
    function buscarTransacoes(viewMode) {
        ...
        fetchedData.forEach(item => {
            ...
            if (viewMode === "total") {
                ...
                item.saldo.transacoes.forEach(transacao => {
                    ...
                    if (isFiltered) {
                        qtd++;
                        valorTotal += parseFloat(transacao.total)
        ...
        if (viewMode !== "total") {
            ...
            total.innerHTML = `<b>Total Filtrado:</b> R$ ${valorTotal.toFixed(2)}`
        }
    ...
    function imprimir(viewMode) {
        ...
        fetchedData.forEach(item => {
            ...
            if (viewMode === "total") {
                ...
                if(filtroEstabelecimento.length === 0 || filtroEstabelecimento.includes(item.estabelecimento)){
